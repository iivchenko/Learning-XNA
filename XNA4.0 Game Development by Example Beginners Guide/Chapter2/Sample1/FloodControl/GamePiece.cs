...
namespace FloodControl
{
    public class GamePiece
    {
        ...
        public void RemoveSuffix(string suffix) { pieceSuffix = pieceSuffix.Replace(suffix, ""); }
        ...
        public void RotatePiece(bool Clockwise)
        {
            switch (pieceType)
            {
                ...
                case "Top,Bottom": pieceType = "Left,Right";
                    break;
                case "Left,Top":
                    if (Clockwise) pieceType = "Top,Right";
                    else pieceType = "Bottom,Left";
                    break;
                case "Top,Right":
                    if (Clockwise) pieceType = "Right,Bottom";
                    else pieceType = "Left,Top";
                    break;
                case "Right,Bottom":
                    if (Clockwise) pieceType = "Bottom,Left";
                    else pieceType = "Top,Right";
                    break;
                case "Bottom,Left":
                    if (Clockwise) pieceType = "Left,Top";
                    else pieceType = "Right,Bottom";
                    break;
                case "Empty": break;
            }
        }
